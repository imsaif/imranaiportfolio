...
const scheduleData: ScheduleItem[] = [
  ...
  { time: '8:30 AM', subject: 'Mathematics', teacher: 'Mr. Okoro', color: 'bg-slate-100 text-slate-800', type: 'lesson' },
  { time: '9:15 AM', subject: 'English', teacher: 'Ms. Adesina', color: 'bg-slate-100 text-slate-800', type: 'lesson' },
  { time: '10:00 AM', subject: 'Short Break', teacher: '', color: 'bg-gray-100 text-gray-800', type: 'break' },
  { time: '10:15 AM', subject: 'Science', teacher: 'Mr. Bello', color: 'bg-slate-100 text-slate-800', type: 'lesson' },
  { time: '11:00 AM', subject: 'Social Studies', teacher: 'Mr. Johnson', color: 'bg-slate-100 text-slate-800', type: 'lesson' },
  { time: '11:45 AM', subject: 'Lunch Break', teacher: '', color: 'bg-gray-100 text-gray-800', type: 'break' },
  { time: '12:30 PM', subject: 'Reading Time', teacher: 'Ms. Adesina', color: 'bg-slate-100 text-slate-800', type: 'lesson' },
  { time: '1:00 PM', subject: 'Art Class', teacher: 'Ms. Rivera', color: 'bg-slate-100 text-slate-800', type: 'lesson' },
  { time: '1:45 PM', subject: 'Physical Education', teacher: 'Coach Adams', color: 'bg-slate-100 text-slate-800', type: 'lesson' },
  { time: '2:30 PM', subject: 'Music Class', teacher: 'Mr. Davis', color: 'bg-slate-100 text-slate-800', type: 'lesson' },
