...
const caseStudyData: CaseStudyPageProps = {
  ...
  cta: 'See Live Demo',
  highlights: [
    { icon: <FaUserTie className="text-slate-500 text-2xl" />, label: 'Role', value: 'Lead Designer & Developer' },
    {
      icon: <FaTools className="text-slate-500 text-2xl" />,
      label: 'Tech',
      value: 'React, Next.js, Framer Motion, Tailwind CSS',
    },
    { icon: <FaRegCalendarAlt className="text-slate-500 text-2xl" />, label: 'Timeline', value: '2024' },
  ],
  sections: [
    {
      heading: 'Challenge',
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        {highlights.map((item, idx) => (
          <motion.div
            ...
            className="flex flex-col items-center bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow p-8 border-t-4 border-slate-400"
          >
      ...
      <main className="max-w-3xl mx-auto px-4 pb-20">
        {sections.map((section, idx) => (
          ...
          >
            <div className="flex items-center mb-4">
              <span className="h-8 w-1 bg-gradient-to-b from-slate-500 to-slate-400 rounded-full mr-4" />
              <h2 className="text-2xl md:text-3xl font-bold text-slate-700 capitalize">{section.heading}</h2>
            </div>
        ...
        <motion.section
          ...
          className="mb-20"
        >
          <div className="bg-gradient-to-br from-slate-50 to-slate-50 rounded-2xl p-8 shadow flex flex-col items-center">
            <FaQuoteLeft className="text-slate-400 text-3xl mb-4" />
        ...
        <motion.section
          ...
          className="mb-20"
        >
          <h2 className="text-2xl md:text-3xl font-bold text-slate-700 mb-6">Gallery</h2>
