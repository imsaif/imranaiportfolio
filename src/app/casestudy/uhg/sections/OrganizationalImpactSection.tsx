      ...
      <div className="mb-20">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 mb-8 shadow-sm">
          <div className="flex items-start gap-4 mb-6">
            <MdAutoAwesome className="text-slate-600 flex-shrink-0" size={28} />
            <div className="flex-1">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                  <p className="font-bold text-slate-900 mb-3">User Segmentation for Design</p>
                  <p className="text-sm text-slate-800 mb-2">
                ...
                <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                  <p className="font-bold text-slate-900 mb-3">Research Without Traditional Testing</p>
                  <p className="text-sm text-slate-800 mb-2">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 mb-8 shadow-sm">
          <div className="flex items-start gap-4 mb-6">
            <MdHandshake className="text-slate-600 flex-shrink-0" size={28} />
            <div className="flex-1">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
          <div className="flex items-start gap-4 mb-6">
            <MdLightbulb className="text-slate-600 flex-shrink-0" size={28} />
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                  <p className="font-bold text-slate-900 mb-3">Within Our Team</p>
                ...
                <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                  <p className="font-bold text-slate-900 mb-3">Cross-Functional Sharing</p>
                  <ul className="space-y-2 text-sm text-slate-800">
