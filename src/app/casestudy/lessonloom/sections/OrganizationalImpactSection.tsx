    ...
    <motion.div {...fadeIn} className="max-w-4xl mx-auto">
      ...
      <div className="space-y-8 mb-12">
        <motion.div
          ...
          transition={{ delay: 0 }}
          className="border-l-4 border-slate-500 pl-6"
        >
          <h3 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-3">
            <MdTrendingUp className="w-6 h-6 text-slate-600" />
            Scale & Efficiency
          </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-slate-50 to-slate-50 rounded-lg p-6 border border-slate-100 text-center">
          <div className="text-3xl font-bold text-slate-600 mb-2">3-4x</div>
