...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-subtle-bg">
      <div className="container mx-auto px-6 md:px-8">
        <h2 className="section-title text-3xl font-bold mb-12">Get in touch</h2>
            ...
            <div>
              ...
              <div className="space-y-4">
                <p className="flex gap-3 items-center text-muted">
                  ...
                  <a href="mailto:imran@example.com" className="hover:text-accent transition-colors">
                    imran@example.com
                  </a>
                </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-accent bg-white"
                  />
                </div>
                ...
                <button
                  ...
                  className={`w-full py-2 px-4 bg-accent hover:bg-accent/90 text-white rounded-md transition-colors ${
