      ...
      <div className="bg-slate-600 text-white px-4 py-3 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-slate-100 text-sm">Mrs. Adesina</p>
          </div>
        </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white rounded p-3 border border-slate-200">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded">15 min</span>
                </div>
                <p className="text-xs text-gray-600">
              ...
              <div className="bg-white rounded p-3 border border-slate-200">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded">10 min</span>
                </div>
                <p className="text-xs text-gray-600">
