  ...
  return (
    ...
    >
      <div className="mb-20">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 mb-8 shadow-sm">
          <div className="flex items-start gap-4 mb-6">
            <MdCheckCircle className="text-slate-600 flex-shrink-0" size={28} />
            <div className="flex-1">
        ...
        <div className="bg-gradient-to-br from-slate-50 via-slate-50 to-slate-50 border border-gray-200 rounded-xl p-8 shadow-sm">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className="flex items-start gap-3 p-3 bg-white rounded-lg border border-gray-200">
                <span className="text-xl text-slate-600 flex-shrink-0">✓</span>
