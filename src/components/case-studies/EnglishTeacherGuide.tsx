...
const EnglishTeacherGuide: React.FC<EnglishTeacherGuideProps> = ({ onBack }) => {
  return (
    <div className="h-full flex flex-col bg-white">
      {/* Fixed Header */}
      <div className="bg-slate-600 text-white px-4 py-3 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center space-x-3">
          {onBack && (
            <button
              onClick={onBack}
              className="flex items-center text-white hover:text-slate-100 transition-colors mr-2"
            >
          ...
          <div>
            ...
            <p className="text-slate-100 text-sm">Ms. Adesina</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Lesson Overview */}
        <section className="bg-slate-50 rounded-lg p-3 border-l-4 border-slate-500">
        ...
        <section className="bg-slate-50 rounded-lg p-3 border-l-4 border-slate-500">
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            <li className="flex items-start">
              <span className="w-2 h-2 bg-slate-500 rounded-full mt-2 mr-2 flex-shrink-0"></span>
          ...
          <div className="space-y-3">
            <div className="bg-white rounded p-3 border border-slate-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded">8 min</span>
              </div>
            ...
            <div className="bg-white rounded p-3 border border-slate-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded">20 min</span>
              </div>
              <p className="text-xs text-gray-600">
            ...
            <div className="bg-white rounded p-3 border border-slate-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded">12 min</span>
              </div>
              <p className="text-xs text-gray-600">
            ...
            <div className="bg-white rounded p-3 border border-slate-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded">5 min</span>
              </div>
              <p className="text-xs text-gray-600">
        ...
        <section className="bg-slate-50 rounded-lg p-3 border-l-4 border-slate-500">
          ...
          <div className="text-sm text-gray-700">
            ...
            <div className="bg-white rounded p-2 border border-slate-200">
              <p className="text-xs font-medium text-slate-700 mb-1">Look for:</p>
