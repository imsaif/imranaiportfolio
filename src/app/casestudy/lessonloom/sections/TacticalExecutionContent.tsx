...
export function TacticalExecutionContent() {
  const fadeIn = {
  ...
  const handleGenerate = () => {
    ...
    // Stage 1: Analyze (0-1200ms) - extended for realistic analysis time
    setTimeout(() => {
    ...
    // Stage 2: Process (1200-2500ms) - extended processing time
    setTimeout(() => {
    ...
    // Stage 3: Generate first batch (2500-4200ms) - slowed lesson counter
    let lessonCounter = 0;
    ...
    // Stage 4: Generate second batch (4200-5900ms) - slowed lesson counter
    setTimeout(() => {
    ...
    // Stage 5: Finalize (5900-7200ms) - slowed lesson counter
    setTimeout(() => {
    ...
    // Complete (7200ms) - total process now ~7.2 seconds
    setTimeout(() => {
  ...
  return (
    <>
        ...
        {/* Challenge Section */}
        <motion.section id="research" className="mb-16" {...fadeIn} transition={{ delay: 0.2 }}>
        ...
        <motion.section id="design" className="mb-16" {...fadeIn} transition={{ delay: 0.4 }}>
          <h2 className="text-3xl font-bold text-gray-800 mb-6">Design Approach</h2>
        ...
        <motion.section id="interactive-demo" className="mb-16" {...fadeIn} transition={{ delay: 0.5 }}>
          ...
          <div className="bg-white p-8 rounded-xl shadow mt-8">
            ...
            <div className="mb-8">
              <h4 className="text-xl font-bold text-gray-800 mb-4">1. Generation Workflow</h4>
              <p className="text-gray-700 mb-6">
                To help educators understand how LessonLoom works, I designed an interactive workflow visualization that breaks down the lesson generation process into clear, understandable steps. This helps users grasp the system's logic before diving into the actual application.
              </p>
              ...
              <div className="border border-gray-200 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg mb-6">
                ...
                <div className="p-10 border-b border-gray-200 min-h-[500px] flex flex-col justify-center">
                  {currentStep === 1 && (
                  ...
                  {currentStep === 6 && (
                    <div className="max-w-xl mx-auto">
                      ...
                      <h4 className="font-bold text-gray-800 mb-3 text-xl">Generated Lessons</h4>
          ...
          <div id="interactive-prototype" className="bg-white p-8 rounded-xl shadow">
            ...
            <p className="text-gray-700 text-base mb-6">
              ...
              <div className="border border-gray-200 rounded-xl overflow-hidden transition-shadow duration-300 hover:shadow-lg mb-6 relative">
                ...
                {/* Two Column Layout */}
                <div className="bg-white flex" style={{ height: '720px' }}>
        ...
        <motion.section id="technical" className="mb-16" {...fadeIn} transition={{ delay: 0.5 }}>
            ...
            <div className="bg-blue-50 rounded-lg p-6 border border-blue-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2 text-gray-700 text-base">
                ...
                <div className="space-y-1">
                  ...
                  <p>• Select lesson templates</p>
                  <p>• AI generates structured lessons</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-6 border border-green-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2 text-gray-700 text-base">
                ...
                <div className="space-y-1.5">
                  ...
                  <p>Must preserve pedagogical control</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-purple-50 rounded-lg p-6 border border-purple-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2 text-gray-700 text-base">
                ...
                <div className="space-y-1.5">
                  ...
                  <p>Tuned from 18% to 3% error rate</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-orange-50 rounded-lg p-6 border border-orange-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2 text-gray-700 text-base">
                ...
                <div className="space-y-1">
                  ...
                  <p>8-12 second generation time</p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                  ...
                  <div className="text-base text-gray-700 space-y-2">
                    ...
                    <p>• Version controlled & updatable</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                  ...
                  <div className="text-base text-gray-700 space-y-2">
                    ...
                    <p>✓ Reduces regeneration time to &lt;30s</p>
                  </div>
                </div>
                ...
                <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
                  ...
                  <div className="text-base text-gray-700 space-y-2">
                    ...
                    <p>✓ Maintained quality despite compression</p>
                  </div>
                </div>
              </div>
        ...
        <motion.section id="ai-deep-dive" className="mb-16" {...fadeIn} transition={{ delay: 0.5 }}>
          ...
          {/* Subsection 3: Quality Assurance & Safety */}
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-red-50 p-6 rounded-lg border border-red-200">
                ...
                <div className="text-base text-gray-700 space-y-2">
                  ...
                  <p>✓ Grammar & clarity checks</p>
                  <p>✓ Assessment rigor validation</p>
                </div>
              </div>
              ...
              <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
                ...
                <div className="text-base text-gray-700 space-y-2">
                  ...
                  <p>✓ Sensitive topic handling</p>
                  <p>✓ Feedback loop to prompts</p>
                </div>
              </div>
            </div>
          ...
          {/* Subsection 4: Testing & Evaluation */}
          <div className="mb-8">
            ...
            {/* Model Comparison */}
            <div className="mb-8">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Model Comparison</h4>

              <div className="overflow-x-auto mb-6">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-gray-100 border border-gray-200">
                      <th className="p-3 text-left font-semibold text-gray-900">Model</th>
                      <th className="p-3 text-center font-semibold text-gray-900">Correctness</th>
                      <th className="p-3 text-center font-semibold text-gray-900">Response Time</th>
                      <th className="p-3 text-center font-semibold text-gray-900">Cost/Lesson</th>
                      <th className="p-3 text-center font-semibold text-gray-900">Selected</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            {/* Prompt Iteration */}
            <div className="mb-8">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Prompt Iteration Journey</h4>
        ...
        {/* Results Section */}
        <motion.section id="results" className="mb-16" {...fadeIn} transition={{ delay: 0.6 }}>
