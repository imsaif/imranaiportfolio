      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        <div className="grid gap-16 grid-cols-1 md:grid-cols-2 lg:grid-cols-7 mb-16">
          ...
          <div className="lg:col-span-3">
            <h3 className="inline-block text-3xl font-bold mb-6 text-black">Looking to enhance your AI experience?</h3>
            <motion.p
              ...
              >
                ...
                <div className="flex gap-12">
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6 fill-gray-600 group-hover:fill-purple-600 transition-colors"
                      viewBox="0 0 24 24"
                    >
