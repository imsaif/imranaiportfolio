...
const Footer = () => (
  <footer>
    <FooterRobot />
    <div className="container mx-auto max-w-6xl py-5 px-4 xs:px-5 sm:px-6 md:px-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-text-tertiary">
