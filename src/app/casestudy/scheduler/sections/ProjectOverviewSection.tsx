  ...
  <section id="overview" className="mb-20">
    <div className="flex flex-col md:flex-row gap-10 items-stretch">
      ...
      <motion.div
        ...
        className="bg-gray-50 rounded-xl p-6 space-y-3 md:w-1/3 w-full"
      >
        <div>
      ...
      <motion.div
        ...
        className="flex-1 bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-sm p-8 flex items-center"
      >
