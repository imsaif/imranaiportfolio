      ...
      <div className="mb-20">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 mb-8 shadow-sm">
          <div className="flex items-start gap-4 mb-6">
            <MdAutoFixHigh className="text-slate-600 flex-shrink-0 mt-1" size={28} />
            <div className="flex-1">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mb-4">
                <p className="font-medium text-slate-900 mb-3">The Challenge</p>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mb-4">
                <p className="font-medium text-slate-900 mb-3">My Approach</p>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-6">
                <p className="font-medium text-slate-900 mb-3">Outcome</p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 mb-8 shadow-sm">
          <div className="flex items-start gap-4 mb-6">
            <MdLightbulb className="text-slate-600 flex-shrink-0 mt-1" size={28} />
            <div className="flex-1">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mb-4">
                <p className="font-medium text-slate-900 mb-3">The Discovery</p>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mb-4">
                <p className="font-medium text-slate-900 mb-3">My Decision</p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
          <div className="flex items-start gap-4 mb-6">
            <MdCheckCircle className="text-slate-600 flex-shrink-0 mt-1" size={28} />
            <div className="flex-1">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mb-4">
                <p className="font-medium text-slate-900 mb-3">The Problem</p>
                <p className="text-slate-800 text-sm leading-relaxed">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mb-4">
                <p className="font-medium text-slate-900 mb-3">How I Solved It</p>
                <ul className="space-y-2 text-slate-800 text-sm">
