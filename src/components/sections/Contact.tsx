            ...
            <div>
              ...
              <div className="space-y-4">
                <p className="flex gap-3 items-center">
                  ...
                  <a href="mailto:imran@example.com" className="hover:underline">
                    imran@example.com
                  </a>
                </p>
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className={`w-full py-2 px-4 bg-accent hover:bg-accent/90 text-white rounded-md transition-colors ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                >
